...
class DateContainerColumnForMeetingDetails extends StatefulWidget {
  const DateContainerColumnForMeetingDetails({
    super.key,
  });

  @override
  State<DateContainerColumnForMeetingDetails> createState() =>
      _DateContainerColumnForMeetingDetailsState();
}

class _DateContainerColumnForMeetingDetailsState
    extends State<DateContainerColumnForMeetingDetails> {
